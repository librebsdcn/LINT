...
>**技巧**
>
>如果在更新系统版本后失去无线网络，请使用命令 `fwget` 重新获取固件。如果没有网络连接，可手动到 <https://mirrors.ustc.edu.cn/freebsd-pkg/FreeBSD%3A14%3Aamd64/kmods_latest_3/All/> 等位置下载所需固件；或者使用 USB 网络共享。安装命令形如 `# pkg add /home/ykla/wifi-firmware-iwlwifi-kmod-20241017.1403000_2.pkg`。
